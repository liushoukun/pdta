...
hero:
  name: "PDTA Protocol"
  text: "产研测AI同频协议"
  tagline: Product-Development-Test-AI Alignment Protocol | 建立统一的协同语言和标准
  actions:
    - theme: brand
      text: 协议规范
      link: /product/
...
features:
  - icon: 📋
    title: 产品文档规范
    details: 产品文档的标准结构、模板和编写规范
    link: /product/
  
  - icon: 👤
    title: 用户手册规范
    details: 面向最终用户的文档规范和编写标准
    link: /user/
  
  - icon: 🤖
    title: 需求管理协议
    details: PRD/TDD/TEST标准模板、流转协议和质量标准
    link: /requirement/
  
  - icon: 🔧
    title: 技术文档规范
    details: 架构、数据库、API文档的标准化规范
    link: /technical/
  
  - icon: 🚀
    title: 运维文档规范
    details: 部署、监控、应急文档的标准和模板
    link: /operations/
  
  - icon: 📚
    title: 培训资料规范
    details: 培训文档的组织结构和编写标准
    link: /training/
  
  - icon: 📊
    title: 项目管理规范
    details: 项目文档的标准化管理和流程规范
    link: /project/
  
  - icon: 💡
    title: 知识库规范
    details: 知识沉淀的分类、组织和管理规范
    link: /knowledge/
---
